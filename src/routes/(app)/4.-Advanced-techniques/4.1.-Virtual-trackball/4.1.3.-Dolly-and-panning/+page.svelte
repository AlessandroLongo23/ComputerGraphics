<script>
    ...
    const render = () => {
        ...
        let panOffset = mv.vec3(cameraState.panOffsetX, cameraState.panOffsetY, 0);
        
        let eye = add(rotatedEye, panOffset);
        let at = add(mv.vec3(0.0, 0.0, 0.0), panOffset);
    ...
    function add(v1, v2) {
        return mv.vec3(v1[0] + v2[0], v1[1] + v2[1], v1[2] + v2[2]);
    }
</script>
